...
//		assertThrows(NoUniqueBeanDefinitionException.class, ()-> ac.getBean(DiscountPolicy.class));
	...
	void findBeanByParentTypeBeanName() {
		DiscountPolicy ratediscouPolicy = ac.getBean("rateDiscountPolicy",DiscountPolicy.class);
		assertThat(ratediscouPolicy).isInstanceOf(RateDiscountPoilicy.class);
	}
	
	@Test
	@DisplayName("특정 하위 타입으로 조회, 안좋은 방법.")
	void findBeanBySubType() {
		RateDiscountPoilicy bean = ac.getBean(RateDiscountPoilicy.class);
		assertThat(bean).isInstanceOf(RateDiscountPoilicy.class);
	}
	
	@Test
	@DisplayName("부모타입으로 모두 조회하기")
	void findBeanByParentTypue() {
